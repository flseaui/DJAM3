    ...
    public class IsoTileBulkEditor : Editor
    {
        ...
        private void ShowTileFilter()
        {
            ...
            if (bFoldout && _bulk._attachedList.Count > 0)
            {
                ...
                using (var scrolled = new EditorGUILayout.ScrollViewScope(tileListScroll, GUILayout.MaxHeight(IsoTileDrawer.RectHeight * 8)))
                {
                    ...
                    try
                    {
                        ...
                        for (int i = iStart; i < iEnd; ++i)
                            EditorGUI.PropertyField(IsoTileDrawer.GetRect(), 
